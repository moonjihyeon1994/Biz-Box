...
public enum CustomOAuth2Provider {
	KAKAO{
		...
		public ClientRegistration.Builder getBuilder(String registrationId) {
			...
			builder.authorizationUri("http://kauth.kakao.com/oauth/authorize");
			builder.tokenUri("http://kauth.kakao.com/oauth/token");
			builder.userInfoUri("http://kauth.kakao.com/v1/user/me");
